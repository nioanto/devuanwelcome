...
NORUN_FLAG = os.path.expanduser("~/.devuan/mintwelcome/norun.flag")

# i18n
gettext.install("devuanwelcome", "/usr/share/devuan/locale")
...
class DevuanWelcome():
    ...
    def __init__(self):
        ...
        window.set_icon_from_file("/usr/share/devuan/logo.png")
        window.set_position(Gtk.WindowPosition.CENTER)
        window.connect("destroy", Gtk.main_quit)

        #with open("/etc/devuan/info") as f:
        #   config = dict([line.strip().split("=") for line in f])

        codename = 'Devuan'									#codename = config['CODENAME'].capitalize()
        edition = 'Jessie 1.0'								#edition = config['EDITION']
        													#release = config['RELEASE']
        desktop = 'mate'
        self.release_notes ='https://devuan.org/'
        self.user_guide = "https://talk.devuan.org/c/study" # Switch to config['USER_GUIDE_URL'] when mintdoc is ready and localized
        self.new_features = 'https://devuan.org/os/packages/'

        # distro-specific
        self.is_lmde = False
        self.dist_name = "Devuan"
        ...
        logo.set_from_file("/usr/share/devuan/devuanwelcome/icons/logo_header.png")
        ...
        welcome_message = _("Welcome and thank you for choosing Devuan. We hope you'll enjoy using it as much as we did designing it. The links below will help you get started with your new operating system. Have a great time and don't hesitate to send us your feedback.")
        ...
        separator = Gtk.Image()
        separator.set_from_file('/usr/share/devuan/devuanwelcome/icons/separator.png')
        ...
        for action in actions:
            desat_pixbuf = Pixbuf.new_from_file('/usr/share/devuan/devuanwelcome/icons/desat/%s.png' % action[0])
            color_pixbuf = Pixbuf.new_from_file('/usr/share/devuan/devuanwelcome/icons/color/%s.png' % action[0])
            pixbuf = desat_pixbuf
...
"""
    ...
    def on_button_toggled(self, button):
        if button.get_active():
            ...
            os.system("mkdir -p ~/.devuan/devuanwelcome")
    ...
    def item_activated(self, view, path):
        ...
        if value == "chatroom":
            ...
            os.system("xdg-open https//talk.devuan.org/ &")
        elif value == "tutorials":
            os.system("xdg-open http://talk.devuan.org/c/hack &")
        elif value == "ideas":
            os.system("xdg-open http://talk.devuan.org/ &")
        elif value == "software":
...
######################################################################################
        ...
        #    os.system("mintdrivers &")
         ...
         #   os.system("xdg-open http://community.linuxmint.com/hardware &")
            ...
            os.system("xdg-open https://devuan.org/os/donate &")
        #elif value == "codecs":
